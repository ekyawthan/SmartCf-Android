...
public class RestClientAdapter {
  ...
  public static void post(String url, StringEntity stringEntity,
      AsyncHttpResponseHandler responseHandler) {
  ...
  public static void post(String url, final RequestParams requestParams,
      AsyncHttpResponseHandler responseHandler) {

    getClient().post(getAbsoluteUrl(url), requestParams, responseHandler);
  }

  public static void postShortTimeOut(String url, final RequestParams requestParams,
      AsyncHttpResponseHandler responseHandler) {
  ...
  private static AsyncHttpClient getClient() {
    ...
    if (Looper.myLooper() == null) return syncClient;
    return asyncClient;
  }
}